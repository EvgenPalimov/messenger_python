...
client. **arg_parser** ()
	...
	* пароль
    ...
    Выполняет проверку на корректность номера порта, IP-адреса, имени и пароля пользователя.


database.py
~~~~~~~~~~~~~~

.. autoclass:: client.databases.database.ClientDatabase
	:members:
...
.. autoclass:: client.forms_gui.start_dialog.UserNameDialog
	:members:
...
.. autoclass:: client.forms_gui.add_contact.AddContactDialog
	:members:
...
.. autoclass:: client.forms_gui.del_contact.DelContactDialog
	:members: