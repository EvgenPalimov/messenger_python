...
class RegisterUser(QDialog):
    ...
    def save_data(self):
        """
        Функция проверки правильности ввода информации и сохранения в базу нового пользователя.
        ...
        if not self.client_name.text():
            ...
            self.messages.information(self, 'Успех', 'Пользователь успешно зарегистрирорван.')
